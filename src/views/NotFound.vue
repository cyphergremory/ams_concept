<template>
	<section class="flex items-center h-full sm:p-16">
		<div class="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
			...
			<p class="text-3xl text-gray-400">Looks like you found the great door to nothing. Great job!</p>
			<a rel="noopener noreferrer" href="http://127.0.0.1:8000" class="px-8 py-3 font-semibold rounded bg-blue-500 hover:bg-indigo-500 text-white">Go back</a>
		</div>
	</section>
</template>